    ...
    <main className="legal-page">
      <section className="legal-shell">
        ...
        <ol>
          ...
          <li>لفصل قناة معينة فقط، اذهب إلى الإعدادات والربط وافصل القنوات التي لا ترغب بالاحتفاظ بها.</li>
          <li>
            لحذف كامل بيانات الحساب فورًا، مالك الحساب يقدر يسويها بنفسه: من صورة الحساب أعلى اللوحة ← الأمان ←
            منطقة الخطر ← حذف الحساب نهائيًا. هذا الإجراء يمسح كل بيانات الشركة (المحادثات، العملاء، الحملات،
            الموظفون، سجل الفواتير) فورًا ولا يمكن التراجع عنه.
          </li>
          <li>
            إذا تعذر الدخول إلى الحساب، أو كان الطلب من غير مالك الحساب، أرسل طلب حذف إلى البريد:
            marketing@audience.sa بعنوان Data Deletion Request، مع ذكر اسم الشركة والبريد المسجل والقنوات المطلوب
            حذف بياناتها.
          </li>
        </ol>
