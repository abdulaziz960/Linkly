...
export const navItems: NavItem[] = [
  ...
  { key: "ai", label: "إعدادات مساعد AI" },
  { key: "knowledgeBase", label: "قاعدة المعرفة" },
  { key: "automations", label: "الأتمتة" },
  { key: "campaigns", label: "الحملات" },
  { key: "segments", label: "تقسيم العملاء" },
  { key: "pipeline", label: "كانبان المبيعات" },
