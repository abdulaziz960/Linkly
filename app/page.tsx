...
export const metadata: Metadata = {
  title: { absolute: "Linkly | صندوق موحّد لواتساب وإنستغرام والقنوات — منصة سعودية لخدمة العملاء" },
  description: "منصة سعودية تجمع محادثات واتساب وإنستغرام والبريد وتيليجرام وتيك توك وتساعد فرق الخدمة والمبيعات على التوزيع والمتابعة من مكان واحد.",
