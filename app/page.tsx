...
const plans = [
  { name:"الأفراد", price:"199", audience:"الأنسب لصاحب عمل يبدأ لحاله ويحتاج يرتب رسائل واتساب.", cta:"ابدأ التجربة", items:["مستخدم واحد","قناة واتساب","رد آلي بسيط وردود سريعة","حملات تسويقية أساسية","تقارير أساسية"] },
  { name:"العادية", price:"279", audience:"الأنسب لصاحب عمل بدأ يكبر ويحتاج قناة ثانية وفريق صغير.", cta:"جرّب الباقة العادية", items:["حتى 3 مستخدمين","واتساب + انستقرام","توزيع محادثات تلقائي","وسوم وتقسيم جمهور بسيط","تقارير أساسية"] },
  { name:"المؤسسات الصغيرة", price:"615", audience:"الأنسب لفريق يحتاج أتمتة وتقسيم جمهور ومساعد ذكاء اصطناعي.", cta:"جرّب باقة المؤسسات الصغيرة", featured:true, items:["حتى 6 مستخدمين","واتساب + انستقرام","فرق عمل متعددة","أتمتة وقواعد تحويل متقدمة","تقسيم جمهور واستهداف بالحملات","مساعد ذكاء اصطناعي (AI Copilot)","تقارير أداء وSLA"] },
  { name:"المؤسسات الكبيرة", price:"849", audience:"الأنسب لفرق متعددة تحتاج قنوات أكثر وواجهات تكامل.", cta:"جرّب باقة المؤسسات الكبيرة", items:["حتى 8 مستخدمين","واتساب + انستقرام + تيك توك","كل مزايا المؤسسات الصغيرة","واجهة برمجة API وWebhooks للمطورين","مساعد ذكاء اصطناعي بحد أعلى","دعم أولوية"] },
  { name:"الشركات", price:"1499", audience:"الأنسب للشركات الكبيرة اللي تحتاج كل القنوات وحساب مخصص.", cta:"تواصل معنا", items:["مستخدمين غير محدودين","كل القنوات المتاحة بالمنصة","علامة تجارية مخصّصة (White-label)","مساعد ذكاء اصطناعي بأعلى حد","مدير حساب مخصص ودعم VIP فوري"] }
] as const;
...
function Preview(){return <div className={s.preview} aria-label="معاينة صندوق محادثات Linkly">
  <header><div><i/><i/><i/></div><b>صندوق Linkly</b><span>متصل</span></header>
  <div className={s.previewBody}><aside><Image src={logo} alt="Linkly" width={42} height={23}/><b>⌁</b><b>◎</b><b>♢</b><b>⚙</b></aside>
  <section className={s.conversations}><div className={s.conversationsTitle}>المحادثات <small>12 جديدة</small></div>{[["و","وليد السبيعي","هل المنتج متوفر اليوم؟",channelNames.whatsapp.ar],["ن","نورة أحمد","وصلتني رسالتكم من الإعلان",channelNames.instagram.ar],["س","شركة سمارت","طلب عرض سعر للفريق",channelNames.email.ar],["م","محمد علي","أحتاج مساعدة في الطلب",channelNames.telegram.ar],["ر","ريم خالد","مهتمة بالربط بعد اعتماد تيك توك",channelNames.tiktok.ar]].map((x,i)=><article className={i===0?s.selected:""} key={x[1]}><em>{x[0]}</em><div><b>{x[1]}</b><p>{x[2]}</p><small>{x[3]} · الآن</small></div></article>)}</section>
